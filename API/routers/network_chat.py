...
def parse_network_command(message: str, history: List[ChatMessage]) -> Dict[str, Any]:
    ...
    if function_call:
        ...
        return {"command_type": "none", "explanation": "No network command detected"}
        ...
        if command_info["command_type"] == "none":
            ...
            if command_info["command_type"] == "change_layout":
                response_data["network_update"] = {
                    "type": "layout",
                    "layout": command_info["parameters"].get("layout_type", "spring"),
                ...
                response_data["visualization_update"] = {
                    ...
                    "property_type": command_info["parameters"].get("property_type", ""),
                    "property_value": command_info["parameters"].get("property_value", ""),
        ...
        messages = [
            {
                ...
                "content": """
                You are a network visualization assistant that helps users visualize and analyze network data.
                Provide helpful responses about network visualization, graph theory, and data analysis.
                """
            }
        ]
